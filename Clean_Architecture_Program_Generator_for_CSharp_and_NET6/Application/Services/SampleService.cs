...
namespace Application.Services
{
    public class SampleService : ISampleService
    {
        ...
        public async Task<(Sample? entity, string Message)> GetSampleById(int Id, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<string> RemoveSample(int Id, CancellationToken cancellationToken = default)
        {
            var item = await _repositoryManager.SampleRepository.GetById(Id);
            if (item == null)
            {
